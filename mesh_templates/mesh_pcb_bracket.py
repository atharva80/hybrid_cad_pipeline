...
def run(BODY_NAME, config):
    ...
    apply_isoline_cone(BODY_NAME, _v('mc.PCB_BRACKET_IsoLine_Cone1.r_min', 2.0), _v('mc.PCB_BRACKET_IsoLine_Cone1.r_max', 2.1), "PCB_BRACKET_IsoLine_Cone1", _v('mc.PCB_BRACKET_IsoLine_Cone1.axial_size', 2), _v('mc.PCB_BRACKET_IsoLine_Cone1.cir_elems', 8), "0,255,255,")

    print("\n[MC2] Cone faces r=2.8-2.9mm...")
    apply_isoline_cone(BODY_NAME, _v('mc.PCB_BRACKET_IsoLine_Cone2.r_min', 2.8), _v('mc.PCB_BRACKET_IsoLine_Cone2.r_max', 2.9), "PCB_BRACKET_IsoLine_Cone2", _v('mc.PCB_BRACKET_IsoLine_Cone2.axial_size', 2), _v('mc.PCB_BRACKET_IsoLine_Cone2.cir_elems', 8), "0,255,0,")
