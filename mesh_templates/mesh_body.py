...
# =============================================================================
# SCRIPT  : mesh_body.py
# PURPOSE : Complete mesh workflow for BODY (optional component)
# MESH CONTROLS:
#   1. Logo Removal — ThicknessBased/LogosAndDetails faces
#   2. IsoLine — Cyl faces r=2-3mm, 2mm axial, 8 circ
# =============================================================================
...
def run(BODY_NAME, config):
    ...
    print("=" * 60)
    print(f"  BODY — Complete Mesh Workflow")
    ...
    # MC1: IsoLine — Bolt cyl faces r=2-3mm
    print("\n[MC1] IsoLine — Bolt cyl faces (r=2-3mm)...")
    simlab.execute(f'''<SelectFeatures UUID="CF82E8FB-9B3E-4c02-BA93-9466C1342C6E" CheckBox="ON">
      ...
      <Cylinders MaxValue="3 mm" MinValue="2 mm" Value="1"/><CylindersAll Value="0"/>
      ...
      <CreateGrp Value="1" Name="BODY_Bolt_Faces"/>
     </SelectFeatures>''')
    ...
    if bolt_faces:
      ...
      <tag Value="-1"/>
      <MeshControlName Value="BODY_IsoLine_Bolt"/>
