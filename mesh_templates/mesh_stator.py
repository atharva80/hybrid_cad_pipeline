...
def run(BODY_NAME, config):
    ...
    AREA_CSV = f"{temp_dir}/stator_area.csv"
    ...
    apply_isoline(BODY_NAME, _v('mc.STATOR_IsoLine_Shaft.r_min', 7.65), _v('mc.STATOR_IsoLine_Shaft.r_max', 7.75), "STATOR_IsoLine_Shaft", _v('mc.STATOR_IsoLine_Shaft.axial_size', 2.5), _v('mc.STATOR_IsoLine_Shaft.cir_elems', 20), "0,255,255,")

    print("\n[MC2] Small cyl faces (r=2.9-3.1mm)...")
    apply_isoline(BODY_NAME, _v('mc.STATOR_IsoLine_SmallCyl.r_min', 2.9), _v('mc.STATOR_IsoLine_SmallCyl.r_max', 3.1), "STATOR_IsoLine_SmallCyl", _v('mc.STATOR_IsoLine_SmallCyl.axial_size', 2.5), _v('mc.STATOR_IsoLine_SmallCyl.cir_elems', 12), "0,255,0,")
