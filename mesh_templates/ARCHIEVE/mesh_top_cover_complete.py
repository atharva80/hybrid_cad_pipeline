...
# ── USER INPUTS ───────────────────────────────────────────────────────────────
mesh_size  = 4        # Average element size in mm
...
simlab.execute(f'''<QCheck UUID="412da11b-2793-4c07-a058-e49f209f007d">
  ...
  <Quality Condition="L Than and G Than Or Eq" MaximumLimitValue="100 mm" MinimumLimitValue="0.25 mm" Name="Edge Length"/>
  <Quality Condition="G Than" LimitValue="75 deg" Name="Skew"/>
  <Quality Condition="L Than" LimitValue="0.5" Name="Jacobian Ratio"/>
  <Quality Condition="L Than" LimitValue="0.2 mm" Name="Height"/>
...
simlab.execute(f'''<TetMesher UUID="83822e68-12bb-43b9-b2ac-77e0b9ea5149">
  ...
  <InternalGrading Value="2"/><MinQuality Value="0.12"/>
