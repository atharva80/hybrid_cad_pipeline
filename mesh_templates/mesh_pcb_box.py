...
def run(BODY_NAME, config):
    ...
    apply_isoline(
        BODY_NAME,
        _v('mc.PCB_BOX_IsoLine_Small.r_min', 1.5),
        _v('mc.PCB_BOX_IsoLine_Small.r_max', 1.8),
        f"{BODY_NAME}_IsoLine_Small",
        _v('mc.PCB_BOX_IsoLine_Small.axial_size', 0.0),
        int(_v('mc.PCB_BOX_IsoLine_Small.cir_elems', 8)),
        "255,206,0,"
    )
    
    print(f"\n[MC2] Medium Cylinders...")
    apply_isoline(
        BODY_NAME,
        _v('mc.PCB_BOX_IsoLine_Medium.r_min', 7.0),
        _v('mc.PCB_BOX_IsoLine_Medium.r_max', 8.0),
        f"{BODY_NAME}_IsoLine_Medium",
        _v('mc.PCB_BOX_IsoLine_Medium.axial_size', 3.0),
        int(_v('mc.PCB_BOX_IsoLine_Medium.cir_elems', 16)),
        "0,255,0,"
    )
